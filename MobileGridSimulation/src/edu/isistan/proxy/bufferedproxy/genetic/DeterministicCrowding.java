...
public class DeterministicCrowding extends PopulationReplacementStrategy {
	...
	private AssignmentFitnessFunction fitnessFunction;
	
	public DeterministicCrowding(AssignmentFitnessFunction fitnessFunction, int numberOfBestIndividuals) {
	...
	private Short[] getBestIndividual(Short[] parent1, Short[] parent2, Short[] child) {
		...
		if (fitnessFunction.evaluate(mostSimilarParent) > fitnessFunction.evaluate(child))
