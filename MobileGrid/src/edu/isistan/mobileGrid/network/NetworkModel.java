...
public abstract class NetworkModel {
	...
	private double AckMessageSizeInBytes = 2346; //http://stackoverflow.com/questions/5543326/what-is-the-total-length-of-pure-tcp-ack-sent-over-ethernet
	...
	protected class NetworkDelayEntity extends Entity{
		...
		public void processEvent(Event e) {
			...
			if((m.getScr().isOnline())&&(m.getDst().isOnline())){
				m.dst.receive(m.scr, m.getId(), m.getData());
